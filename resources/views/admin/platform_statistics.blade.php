    ...
    <div class="analytics-grid">
        ...
        <div class="analytics-card">
            ...
            <div style="margin-top: 0.5rem;">
                <a href="{{ route('admin_withdraw_requests') }}" style="background: #ef4444; color: white; padding: 0.25rem 0.75rem; border-radius: 6px; text-decoration: none; font-size: 0.8rem;">
                    Review Requests
                </a>
            </div>
            @endif
